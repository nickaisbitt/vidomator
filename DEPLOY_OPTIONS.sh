...
echo ""
echo "2. Click 'New' → 'Deploy from GitHub repo'"
echo "   Or if local: 'Deploy from code' and upload this folder"
echo ""
echo "3. Railway will auto-detect docker-compose.yml and create:"
echo "   - n8n service"
echo "   - render-service"
echo ""
...
echo ""
echo "5. Deploy and get domain from dashboard"
echo ""
echo "6. Set domain variables:"
